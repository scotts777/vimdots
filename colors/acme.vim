...
highlight! Search guibg=#ffffea guifg=#000000 ctermbg=195 ctermfg=232 
highlight! MatchParen guibg=#f6e6fa guifg=#000000 ctermbg=201 
highlight! NormalFloat guibg=#faf9f7 guifg=#000000 ctermbg=255 ctermfg=232
...
highlight! Visual guibg=fg guifg=bg ctermbg=190 ctermfg=fg
highlight! CursorLine ctermbg=187 ctermfg=fg cterm=bold
highlight! Cursor cterm=bold ctermbg=173 ctermfg=173
highlight! Pmenu guibg=#ab9f80 guifg=#000000 ctermbg=179 ctermfg=232
...
highlight! Comment guibg=bg guifg=#303030 gui=italic ctermbg=bg ctermfg=153 cterm=italic
